...
CEVIRILER = {
    ...
    "en": {
        ...
        "boot_checking":        "Checking for available models...",
        "boot_found":           "Server already running!",
        "boot_not_found":       "Server not running. Starting via LM Studio CLI...",
        "boot_launching":       "Starting LM Studio server...",
        "boot_waiting":         "Waiting for server... ({s}s)",
        "boot_lms_not_installed": "LM Studio CLI (lms) not found. Please install LM Studio.",
        "boot_ready":           "Server started! Loading model...",
        "boot_failed":          "Server could not start after {s}s.\nTry running manually: lms server start",
        "boot_manual":          "Skip & Continue",
        "boot_retry":           "Retry",
        "boot_quit":            "Quit",
        "boot_no_models":       "No models found. Please download a model in LM Studio first.",
        "boot_select_model":    "Select AI Model",
        "boot_model_hint":      "Choose the model you want to use for this session:",
        "boot_model_loading":   "Loading model: {m}...",
        "boot_model_loaded":    "Model loaded successfully!",
        "boot_model_err":       "Failed to load model. Try again.",
        "boot_server_starting": "Starting LM Studio server (lms server start)...",
        "boot_server_running":  "Server is running on port 1234!",
        "boot_server_stop":     "Shutting down LM Studio server...",
        "boot_server_stopped":  "Server stopped.",
        "boot_fetching":        "Fetching installed models...",
        "boot_lms_missing":     "'lms' command not found. Install LM Studio and ensure it's in PATH.",
        "boot_btn_select":      "Use This Model",
    ...
    "tr": {
        ...
        "boot_checking":        "Yüklü modeller aranıyor...",
        "boot_found":           "Sunucu zaten çalışıyor!",
        "boot_not_found":       "Sunucu çalışmıyor. LM Studio CLI ile başlatılıyor...",
        "boot_launching":       "LM Studio sunucusu başlatılıyor...",
        "boot_waiting":         "Sunucu bekleniyor... ({s}s)",
        "boot_lms_not_installed": "LM Studio CLI (lms) bulunamadı. Lütfen LM Studio'yu yükleyin.",
        "boot_ready":           "Sunucu başlatıldı! Model yükleniyor...",
        "boot_failed":          "Sunucu {s}s içinde başlatılamadı.\nManuel deneyin: lms server start",
        "boot_manual":          "Atla & Devam Et",
        "boot_retry":           "Tekrar Dene",
        "boot_quit":            "Çıkış",
        "boot_no_models":       "Model bulunamadı. Lütfen önce LM Studio'dan model indirin.",
        "boot_select_model":    "AI Model Seç",
        "boot_model_hint":      "Bu oturum için kullanmak istediğiniz modeli seçin:",
        "boot_model_loading":   "Model yükleniyor: {m}...",
        "boot_model_loaded":    "Model başarıyla yüklendi!",
        "boot_model_err":       "Model yüklenemedi. Tekrar deneyin.",
        "boot_server_starting": "LM Studio sunucusu başlatılıyor (lms server start)...",
        "boot_server_running":  "Sunucu 1234 portunda çalışıyor!",
        "boot_server_stop":     "LM Studio sunucusu kapatılıyor...",
        "boot_server_stopped":  "Sunucu durduruldu.",
        "boot_fetching":        "Yüklü modeller alınıyor...",
        "boot_lms_missing":     "'lms' komutu bulunamadı. LM Studio'yu yükleyin ve PATH'e eklendiğinden emin olun.",
        "boot_btn_select":      "Bu Modeli Kullan",
